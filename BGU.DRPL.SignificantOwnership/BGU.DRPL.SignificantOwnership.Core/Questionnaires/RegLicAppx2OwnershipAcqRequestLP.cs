...
namespace BGU.DRPL.SignificantOwnership.Core.Questionnaires
{
    ...
    public class RegLicAppx2OwnershipAcqRequestLP : IQuestionnaire
    {
        ...
        public List<OwnershipStructure> ExistingOwnershipDetails { get; set; }
        ...
        public List<OwnershipStructure> AcquireeOwnershipOtherThanBank { get; set; }
        ...
        // див. PersonsLinks
        /// 4.7. Перелік  банків,  у яких юридична особа є власником істотної  участі або афілійованою особою, ________________________________________________________________________.
        ...
        /// _______________________________________________________________________________.
        /// 
        /// 6.4. Чи була юридична особа протягом останнього року, що передував прийняттю рішення про ліквідацію юридичної особи,  власником істотної участі (10 і більше відсотків) у цій особі? __________________________________________________________________________
        ///                                                                                                (найменування юридичної особи,
        /// 
        /// _______________________________________________________________________________.
