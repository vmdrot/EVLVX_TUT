...
namespace Drive.Sample
{
    ...
    class Program
    {
        ...
        private const string UploadFileName = @"D:\home\vmdrot\Testing\Evolvex.SpilnoTV.HR\-8ydhcVMAjM.jpg";

        // CHANGE THIS with a download directory
        private const string DownloadDirectoryName = @"D:\home\vmdrot\Testing\Evolvex.SpilnoTV.HR\dnld";
